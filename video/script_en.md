...
| 5 | 1:25–1:55 | Recognition: red line over grates (`red-line-over-grates.jpg`) | We used OpenCV to find the grates and the red line. In 16 out of 16 top-down photos, the new red line runs straight across a grate. |
...
| 7 | 2:15–2:40 | Card-as-ruler photo (grate 7) | Our ruler is the red line itself: 10 cm wide by law. We checked it with a real card and measured 95 to 97 mm. The red line moved out by about 0.6 m. |
...
| 9 | 3:10–3:30 | Withdrawn: why our 10 to 1 was wrong (`f40_picks.jpg`) | We first published 10 to 1. When we checked again, we found the program had picked the wrong lines, and the answer changed with image quality. We withdrew it. Now two different tools have to agree before we use a number. |
